...
6. **Güvenlik Kalkanı (Guardrail):** Siber saldırılara (Prompt Injection, SQL Injection), kod enjeksiyonu ve programlama komutu çalıştırma denemelerine (Code Injection/Execution - Örn: `print()`, `os.system()`, `import os` vb.) ve toksik/argo kullanıma karşı özel bir Python kalkanı geliştirilmiştir. Yasaklı kod ifadeleri veya kelimeler LLM'e ulaşmadan arayüzde yakalanıp engellenir.
